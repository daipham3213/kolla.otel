...
class ExtraVarsTestCase:
    """Translation of the config model into the role's ``otel_*`` vars."""

    def test_default_container_name_hyphens_to_underscores(self) -> None:
    ...
    def test_to_extra_vars_maps_config_fields(self) -> None:
    ...
    def test_to_extra_vars_omits_optional_fields_when_unset(self) -> None:
        """Deployment environment / extra attributes omitted when unset."""
        extra = to_extra_vars(
    ...
    def test_to_extra_vars_omits_empty_endpoint_for_local_mode(self) -> None:
    ...
    def test_to_extra_vars_builds_service_entries(self) -> None:
    ...
    def test_to_extra_vars_skips_disabled_specs(self) -> None:
